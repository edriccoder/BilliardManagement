...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql .= " WHERE user_id = :user_id AND role = 'user'"; // Ensuring the role is 'user'
    ...
    if ($stmt->execute()) {
        echo "<script>alert('User updated successfully.'); window.location.href = 'udpate_user.php';</script>";
    } else {
